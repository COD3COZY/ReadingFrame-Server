...
public class BookService {
    ...
    public ResponseEntity<DefaultResponse> createBook(Long memberId, String isbn, ReadingBookCreateRequest request) {
        ...
        if (request.mainLocation() != null) {
            ...
            // 이미 있는 위치인지 검색
            locationInfo = locationRepository.findByPlaceName(request.mainLocation().placeName());
    ...
    public ResponseEntity<DefaultResponse> deleteComment(Long memberId, String isbn) {
        ...
        if (bookReview != null) {
            ...
            if (bookReviewReviewer != null) {
                bookReviewReviewerRepository.deleteAllByBookReview(bookReview);
            }
    ...
    public ResponseEntity<DefaultResponse> addMainLocation(Long memberId, String isbn, LocationRequest request) {
        ...
        // 장소명으로 해당 주소 찾기
        LocationInfo locationInfo = locationRepository.findByPlaceName(request.placeName());
        // 등록되지 않은 주소면 새로 등록
        if (locationInfo == null) {
    ...
    public ResponseEntity<DefaultResponse> deleteBookmark(Long memberId, String isbn, DeleteUuidRequest request) {
        ...
        if (bookmark != null) {
            ...
            if (bookmark.getLocationInfo() != null) {
                // 참조하고 있는 위치 받아오기
                LocationInfo deleteLocation = locationRepository.findByLocationId(bookmark.getLocationInfo().getLocationId());
    ...
    public ResponseEntity<DefaultResponse> deleteRecentLocation(Long memberId, DeleteRecentLocationRequest request) {
        ...
        // 전체 위치에서 검색
        LocationInfo locationInfo = locationRepository.findByLocationId(request.locationId());
        if (locationInfo != null) {
    ...
    public ResponseEntity<DefaultResponse> getMarkDetail(Long memberId, MarkDetailRequest request) {
        ...
        LocationInfo locationInfo = locationRepository.findByLocationId(locationId);
    ...
    public LocationInfo registerLocation(String placeName, String address, double latitude, double longitude) {
        locationRepository.save(LocationInfo.create(placeName, address, latitude, longitude));
